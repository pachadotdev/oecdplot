#' @title Wrapper to simplify column and diamond plots.
#'
#' @description Create a column and diamond plot with a wrapper around the geom_col and geom_point functions.
#'
...
#' @importFrom dplyr ungroup
#' @importFrom ggplot2 ggplot aes layer_data labs geom_point
#'
#' @export
oecd_coldiamond <- function(data = NULL,
                      x = NULL,
                      y = NULL,
                      colour = NULL,
                      size = NULL,
